...
int candies(int arr[],int n,int k,int mid)
{
    int sum=0;
    for(int i=0;i<n;i++)
    {
...
Input
First line contains 1<=T<=20 the number of test cases. Then T test cases follow. First line of each test case contains 
N and K. Next line contains N integers, ith of which is the number of candies in ith box.
Output
