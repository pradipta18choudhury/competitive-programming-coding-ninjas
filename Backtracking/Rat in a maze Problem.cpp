...
Value of every cell in the maze can either be 0 or 1. Cells with value 0 are blocked means rat can
not enter into those cells and those with value 1 are open.
Input Format
...
Output Format :
For each test case, print the path from start position to destination position and only cells
