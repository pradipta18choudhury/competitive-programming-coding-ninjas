...
wants to know the number of ways he can distribute these N candies to his N students such that every student gets exactly one candy he likes.
Input Format :
...
long long solve(int like[][MAXN],int N)
{
    ...
    {
        dp[i]=0;
        //as 0 number of ways are possible
    }
    dp[0]=1;//no candies i give ,so 1 way possible
